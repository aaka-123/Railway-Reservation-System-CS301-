...
public class create_database {
    ...
    public static void main(String[] args) {
        ...
        String query3 = "create table trains ( train_no int  , doj varchar(12) , ac_coaches int , sl_coaches int, primary key (train_no , doj), foreign key (train_no) references train_avail(train_no))";
